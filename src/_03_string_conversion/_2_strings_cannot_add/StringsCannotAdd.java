...
public class StringsCannotAdd {
		...
		public static void main(String[] args) {
			...
			String fourAsString=JOptionPane.showInputDialog("*put the number four into here*");
			// 3) Ask the user to enter number 6 and hold it in the variable sixAsString 
			String sixAsString=JOptionPane.showInputDialog("*put the number six into here*");
			...
			String fiveAsString=JOptionPane.showInputDialog("*put the number five into here*");
